...
f=open("data_cm.txt","r") #change cm to cb to obtain the second figure
lines=f.readlines()
f.close()
...
plt.hist(data,bins=math.ceil(1+math.log2(100)),edgecolor="black",color="white",density=True,label="frequência exp.")
